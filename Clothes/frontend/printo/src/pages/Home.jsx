...
export function Home() {
  ...
  const tshirtTitles = [
    "Vintage Classic T-Shirt",
    "Essential Cotton T-Shirt",
    "Premium Comfort T-Shirt",
    "Modern Basic T-Shirt",
    "Signature Classic T-Shirt",
    "Urban Style T-Shirt",
    "Casual Fit T-Shirt",
  ...
  const getRandomTitle = () => {
    const randomIndex = Math.floor(Math.random() * tshirtTitles.length);
    return tshirtTitles[randomIndex];
  };
            ...
            <div className="lg:w-1/2 bg-gray-50 rounded-xl p-6 shadow-lg">
              ...
              >
                <div className="relative">
                  ...
                  >
                    <path
                      d="M75,20 L225,20 L250,80 L300,60 L270,150 L250,150 L250,330 L50,330 L50,150 L30,150 L0,60 L50,80 L75,20"
                      fill={color}
                      stroke="#cccccc"
                      strokeWidth="2"
                      id="tshirt-body"
                    ></path>
                    <path
                      d="M75,20 C75,20 100,50 150,50 C200,50 225,20 225,20"
                      fill="none"
                      stroke="#cccccc"
                      strokeWidth="2"
                    ></path>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold">PrintCanvas</span>
              </div>
              <p className="text-gray-400 mb-4">
                Custom apparel printing made simple. Quality products, fast
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>© 2023 PrintCanvas. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
